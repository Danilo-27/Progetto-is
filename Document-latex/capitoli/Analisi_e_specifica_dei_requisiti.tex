...
\Req{rf}{04} & Il sistema deve offrire agli utenti autenticati l’accesso a un profilo personale & 6 \\
\Req{rf}{05} & Il sistema deve offrire la possibilità agli utenti autenticati di modificare i propri dati personali & 7 \\
...
\Req{rf}{08} & Il sistema deve fornire la possibilità di filtrare il catalogo eventi per data o località & 11 \\
...
\Req{rf}{15} & Il sistema deve tener traccia dinamicamente del numero di partecipazioni per ogni evento & 20 \\
\Req{rf}{16} & Il sistema deve permettere l’accesso ad un pannello per la gestione degli eventi agli amministratori & 21 \\
\Req{rf}{17} & Il sistema deve permettere agli amministratori di visualizzare il numero di partecipanti presenti per ogni evento in corso & 22 \\
\Req{rf}{18} & Il sistema deve fornire, per gli eventi passati, il numero totale di partecipanti che hanno avuto accesso & 23 \\
\end{tblr}
...
\Req{V}{03} & Il sistema deve offrire un’interfaccia grafica chiara e intuitiva & 25 \\
\Req{RNF}{01} & Il sistema deve implementare meccanismi di sicurezza per la protezione dei dati personali & 24 \\
\Req{RNF}{04} & Il sistema deve garantire l’integrità dei biglietti elettronici & 26 \\
\Req{RNF}{05} & Il sistema deve essere accessibile da dispositivi mobili e desktop & 27 \\
