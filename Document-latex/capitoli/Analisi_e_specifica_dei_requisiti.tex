...
\Req{rf}{03} & il sistema deve gestire per ogni cliente lo storico dei biglietti acquistati, numero totali di eventi a cui l’cliente ha partecipato e un ImmagineProfilo & 4 \\
...
\Req{rf}{07} & Il sistema deve offrire un catalogo eventi consultabile da un cliente registrato & 9 \\
...
\Req{rf}{14} & Il sistema deve consentire all’cliente partecipare ad un evento & 15 \\
...
\Req{V}{02} & Un cliente registrato durante la fase di acquisto può comprare un solo biglietto & 17\\
