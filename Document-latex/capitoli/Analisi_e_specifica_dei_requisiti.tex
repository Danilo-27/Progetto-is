...
\Req{rf}{11} & il sistema deve offrire la possibilità all’cliente di visualizzare un biglietto acquistato & 13 \\
\Req{rf}{12} & Il sistema deve offrire la possibilità all’cliente di scaricare un biglietto acquistato & 14\\
...
\Req{V}{03} & Il sistema deve implementare meccanismi di sicurezza per la protezione dei dati personali e per l’autenticazione degli utenti & 21\\
