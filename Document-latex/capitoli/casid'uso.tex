...
\begin{center}
Come visibile dal sequence diagram del caso d'uso \textit{ModificaDatiPersonali} è stato necessario fornire alla classe \textbf{Cliente} un metodo privato, di istanza, \textbf{VerificaDato(Dato,Valore)}
