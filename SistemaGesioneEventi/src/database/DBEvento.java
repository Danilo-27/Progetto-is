...
//metodo per prelevare tutti gli eventi dal database
    ...
    public int SalvaInDB() {
        int ret = 0;
        String query = "INSERT INTO eventi(titolo,descrizione,data,ora,luogo,capienza,Idamministratore) VALUES ( '" + this.titolo + "','"+ this.descrizione+ "','" + this.data + "','" + this.ora + "','" + this.luogo + "','"+ this.capienza + "','"+ this.Idamministratore +"')";
        try {
